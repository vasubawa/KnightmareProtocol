...
@tool()
async def run_ops():
    print("Starting notification_agent agent...")
    while True:
        print("notification_agent agent running main loop...")
...
notification_agent = Agent(
    ...
    instruction="Orchestrate timely notifications and tailor messaging to user context.",
    tools=[run_ops],
)
